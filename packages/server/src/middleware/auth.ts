...
import type { Institution, InstitutionMember, TeacherClass, User } from '../db/types'
...
export type AppEnv = {
  Variables: {
    ...
    /** 教师端权限中间件解析出的机构、成员关系与班级 */
    institution: Institution | undefined
    institutionMember: InstitutionMember | undefined
    teacherClass: TeacherClass | undefined
    /** 教师端权限中间件已回查过的当前用户，避免下游路由重复查询 */
    teacherUser: User | undefined
  }
}
