...
import { initializeXiaobaoProductionAdapters } from './agent/xiaobao-runtime/dependencies.js'
...
const disposeXiaobaoProductionAdapters = initializeXiaobaoProductionAdapters()
if (!disposeXiaobaoProductionAdapters) {
  console.warn('[Server] XiaoBao production adapters unavailable')
}
...
const gracefulShutdown = (signal: string) => {
  ...
  disposeXiaobaoProductionAdapters?.()
  stopAllCronJobs()
  process.exit(0)
}
